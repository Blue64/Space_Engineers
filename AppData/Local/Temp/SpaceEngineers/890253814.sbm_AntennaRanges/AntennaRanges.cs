...
namespace Cheetah.AntennaRanges
{
    ...
    public sealed class Loader : MyGameLogicComponent
    {
        ...
        {
            { "LargeBlockRadioAntenna", 50000 },
            { "SmallBlockRadioAntenna", 5000 },
            { "LBShortRadioAntenna", 35000 },
            { "SBLongRadioAntenna", 25000 },
            { "SBAngledRadioAntenna", 15000 },
        };
