...
namespace AnimaData
{
    public class Seq_SC_Radar_powerOff : AnimaSeqBase
    {
        private static AnimaSeqBase m_seq = null;
        new public static AnimaSeqBase Adquire()
        {
            if (m_seq == null) m_seq = PManAdd(new Seq_SC_Radar_powerOff());
            return m_seq;
        }
        ...
        {
            PInit("Seq_SC_Radar_powerOff",0,60,24f,0,0);
            PLocRotScale(-0f,0f,0f,-0f,0f,0f,1f,1f,1f,1f);
        }
    }
    public class Seq_SC_Radar_Part1_powerOff : AnimaSeqBase
    {
        private static AnimaSeqBase m_seq = null;
        new public static AnimaSeqBase Adquire()
        {
            if (m_seq == null) m_seq = PManAdd(new Seq_SC_Radar_Part1_powerOff());
            return m_seq;
        }
        public override void DiscardStatic() { m_seq = PManRem(m_seq); }
        new public static void Discard() { m_seq = PManRem(m_seq); }
        protected override void PData()
        {
            PInit("Seq_SC_Radar_Part1_powerOff",0,60,24f,0,60);
            PLocRotScale(-0f,0f,0f,-0f,0f,0f,1f,1f,1f,1f);
    ...
    public class Seq_SC_Radar_Part2_powerOff : AnimaSeqBase
    {
        private static AnimaSeqBase m_seq = null;
        new public static AnimaSeqBase Adquire()
        {
            if (m_seq == null) m_seq = PManAdd(new Seq_SC_Radar_Part2_powerOff());
            return m_seq;
        }
        public override void DiscardStatic() { m_seq = PManRem(m_seq); }
        new public static void Discard() { m_seq = PManRem(m_seq); }
        protected override void PData()
        {
            PInit("Seq_SC_Radar_Part2_powerOff",0,60,24f,0,60);
    ...
    public class Seq_SC_Radar_Part3_powerOff : AnimaSeqBase
    {
        private static AnimaSeqBase m_seq = null;
        new public static AnimaSeqBase Adquire()
        {
            if (m_seq == null) m_seq = PManAdd(new Seq_SC_Radar_Part3_powerOff());
            return m_seq;
        }
        public override void DiscardStatic() { m_seq = PManRem(m_seq); }
        new public static void Discard() { m_seq = PManRem(m_seq); }
        protected override void PData()
        {
            PInit("Seq_SC_Radar_Part3_powerOff",0,60,24f,0,60);
            ...
            PLocRotScale(-0f,-0.975f,0f,-0f,0f,0.333807f,0.942642f,1f,1f,1f);
            ...
            PLocRotScale(-0f,-0.975f,0f,-0f,0f,0.27144f,0.962455f,1f,1f,1f);
            ...
            PLocRotScale(-0f,-0.975f,0f,-0f,0f,0.162895f,0.986643f,1f,1f,1f);
            PLocRotScale(-0f,-0.975f,0f,-0f,0f,0.156434f,0.987688f,1f,1f,1f);
            ...
            PLocRotScale(-0f,-0.975f,0f,-0f,0f,0.104529f,0.994522f,1f,1f,1f);
            PLocRotScale(-0f,-0.975f,0f,-0f,0f,0.0980171f,0.995185f,1f,1f,1f);
            ...
            PLocRotScale(-0f,-0.975f,0f,-0f,0f,0.0719326f,0.99741f,1f,1f,1f);
            ...
            PLocRotScale(-0f,-0.975f,0f,-0f,0f,0.0457988f,0.998951f,1f,1f,1f);
            ...
            PLocRotScale(-0f,-0.975f,0f,-0f,0f,0.0261769f,0.999657f,1f,1f,1f);
            ...
            PLocRotScale(-0f,-0.975f,0f,-0f,0f,0.00654493f,0.999979f,1f,1f,1f);
