...
namespace Cheetah.AI
{
    ...
    abstract public class BotBase
    {
        ...
        protected float GridRadius
        {
            get
            {
                return (float)Grid.WorldVolume.Radius;
            }
        }
        ...
        protected string DroneNameProvider
        {
            get
            {
                return $"Drone_{RC.EntityId}";
            }
        }
        ...
        protected List<Ingame.MyDetectedEntityInfo> LookForEnemies(float Radius, bool ConsiderNeutralsAsHostiles = false)
        {
            if (!ConsiderNeutralsAsHostiles)
                return LookAround(Radius, x => x.Relationship == MyRelationsBetweenPlayerAndBlock.Enemies);
            else
                return LookAround(Radius, x => x.Relationship == MyRelationsBetweenPlayerAndBlock.Enemies || x.Relationship == MyRelationsBetweenPlayerAndBlock.Neutral);
        }
