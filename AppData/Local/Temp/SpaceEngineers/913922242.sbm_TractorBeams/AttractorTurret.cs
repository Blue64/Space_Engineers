...
namespace Cython.EnergyWeapons
{
    ...
    public class TractorBeamTurret : MyGameLogicComponent
    {
        ...
        public void appendCustomInfo(Sandbox.ModAPI.IMyTerminalBlock block, StringBuilder info)
        {
            ...
            info.AppendLine("Maximum Input: " + (attractorWeaponInfo.powerUsage / efficiencyUpgrades).ToString("N") + "MW");
        ...
        private void getAttractorWeaponInfo(string name) {
            ...
            if (subtypeName == "LargeTractorBeam") {
                attractorWeaponInfo = EnergyWeaponManager.largeBlockAttractorTurret;
            }
        ...
        {
            var maincolor = Color.Green.ToVector4();
            var auxcolor = Color.Orange.ToVector4();
