namespace IndustrialAutomaton.MaintenanceAstromech
{
   ...
   static class Mod
   {
      public static Logging Log = new Logging("AstromechBuildAndRepairSystem", 0, "AstromechBuildAndRepairSystem.log", typeof(NanobotBuildAndRepairSystemMod)) {
   ...
   public class NanobotBuildAndRepairSystemMod : MySessionComponentBase
   {
      ...
      private static ushort MSGID_MOD_DATAREQUEST = 41000;
      private static ushort MSGID_MOD_SETTINGS = 41001;
      private static ushort MSGID_BLOCK_DATAREQUEST = 41100;
      private static ushort MSGID_BLOCK_SETTINGS_FROM_SERVER = 41102;
      private static ushort MSGID_BLOCK_SETTINGS_FROM_CLIENT = 41103;
      private static ushort MSGID_BLOCK_STATE_FROM_SERVER = 41104;
