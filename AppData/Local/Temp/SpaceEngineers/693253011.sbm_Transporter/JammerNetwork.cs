...
namespace LSE.JammerNetwork
{
    ...
    class NetworkSessionJammer : MySessionComponentBase
    {
    ...
    public static class MessageUtils
    {
        ...
        public static readonly ushort MessageId = 3012;//69325+;
    ...
    public class MessageClientConnected : MessageBase
    {
        ...
        public override void ProcessServer()
		{
            ...
            {
                foreach (var jammer in Jammer.ScramblerList)
                {
                    MyAPIGateway.Multiplayer.ReplicateEntityForClient(jammer.CubeBlock.CubeGrid.EntityId, 0);
                }
            }
    ...
    public class MessageSync : MessageBase
    {
        ...
        public void Proc()
        {
            ...
            {
                var jammer = block.GameLogic.GetAs<LSE.Jammer>();
                jammer.Slider.SetterOutside((IMyTerminalBlock)block, Value);
            }
        }
    }
