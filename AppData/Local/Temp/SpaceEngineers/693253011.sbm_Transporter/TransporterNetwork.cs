...
namespace LSE.TransporterNetwork
{
    ...
    class NetworkSessionTP : MySessionComponentBase
    {
    ...
    public class MessageClientConnected : MessageBase
    {
        ...
        public override void ProcessServer()
		{
            ...
            {
                foreach (var transporter in Transporter.TeleporterList)
                {
                    MyAPIGateway.Multiplayer.ReplicateEntityForClient(transporter.CubeBlock.CubeGrid.EntityId, 0);
                }
            }
