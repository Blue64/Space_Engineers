...
namespace NaniteConstructionSystem.Entities.Effects
{
    public abstract class NaniteBlockEffectBase
    {
        ...
        private void GetModelsFolder()
        {
            ...
            {
                if (mod.PublishedFileId == 655922051)
            ...
            if (publishID != 0)
                ...
                m_modelsFolder = Path.GetFullPath(string.Format(@"{0}\{1}\Models\Cubes\large\", MyAPIGateway.Utilities.GamePaths.ModsPath, "NaniteConstructionSystem"));
        }
